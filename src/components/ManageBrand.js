        ...
        var listJSX = this.state.brandList.map((item) => {
            ...
            return (
                <tr>
                    <td>{item.id}</td>
                    <td>{item.nama}</td>
                    <td><img src={`${this.state.API_URL}${item.image}`} alt={item.nama} width={100} /></td>
                    ...
                    <table>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><CustomInput type="file" id="AddBrandImage" name="AddBrandImage" 
                                label={this.state.AddBrandImage} onChange={this.onAddFileImageChange} /></td>
                                <td colSpan="2">
                                <center><input type="button" class="btn btn-success" value="Add" 
                                onClick={this.onBtnAddClick} /></center></td>
                            </tr>
                        </tfoot>
                    </table>
                </center>
